...
static constexpr std::string_view Outset = "outset";
static constexpr std::string_view Inset = "inset";
static constexpr std::string_view Ridge = "ridge";
static constexpr std::string_view Groove = "groove";
...
static constexpr std::string_view Pointer = "pointer";
static constexpr std::string_view Text = "text";
static constexpr std::string_view NoWrap = "nowrap";
static constexpr std::string_view Uppercase = "uppercase";
static constexpr std::string_view Lowercase = "lowercase";
static constexpr std::string_view Capitalize = "capitalize";
static constexpr std::string_view Ellipsis = "ellipsis";
...
static constexpr std::string_view RepeatX = "repeat-x";
...
static constexpr std::string_view Grid = "grid";
static constexpr std::string_view Span = "span";
static constexpr std::string_view Row = "row";
static constexpr std::string_view RowReverse = "row-reverse";
static constexpr std::string_view Column = "column";
static constexpr std::string_view ColumnReverse = "column-reverse";
static constexpr std::string_view Wrap = "wrap";
static constexpr std::string_view WrapReverse = "wrap-reverse";
static constexpr std::string_view FlexStart = "flex-start";
static constexpr std::string_view FlexEnd = "flex-end";
static constexpr std::string_view Start = "start";
static constexpr std::string_view End = "end";
static constexpr std::string_view SpaceBetween = "space-between";
