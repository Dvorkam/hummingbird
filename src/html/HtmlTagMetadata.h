...
inline bool closes_paragraph_on_start(std::string_view name) {
    static constexpr std::string_view kParagraphClosingTags[] = {
        Hummingbird::Html::TagNames::P,          Hummingbird::Html::TagNames::Div,   Hummingbird::Html::TagNames::Dl,
        Hummingbird::Html::TagNames::Dt,         Hummingbird::Html::TagNames::Dd,    Hummingbird::Html::TagNames::Ul,
        Hummingbird::Html::TagNames::Ol,         Hummingbird::Html::TagNames::Li,    Hummingbird::Html::TagNames::Pre,
        Hummingbird::Html::TagNames::Blockquote, Hummingbird::Html::TagNames::Table, Hummingbird::Html::TagNames::Thead,
        Hummingbird::Html::TagNames::Tbody,      Hummingbird::Html::TagNames::Tfoot, Hummingbird::Html::TagNames::Tr,
        Hummingbird::Html::TagNames::Td,         Hummingbird::Html::TagNames::Th,    Hummingbird::Html::TagNames::Form,
        Hummingbird::Html::TagNames::Hr,         Hummingbird::Html::TagNames::H1,    Hummingbird::Html::TagNames::H2,
        Hummingbird::Html::TagNames::H3,         Hummingbird::Html::TagNames::H4,    Hummingbird::Html::TagNames::H5,
        Hummingbird::Html::TagNames::H6,
    };
