...
- [ ] **[M3 P2] T-BRAND-1: Windows ICO Sizes**; Goal: add 48/64/128 sizes to ico; Scope: `assets/logos/hummingbird.ico`; Acceptance: Windows scaling looks correct at common sizes; Tests: n/a.
...
- [ ] **[M3 P2] T-REFAC-4: Consolidate Utilities + Include Paths**; Goal: reduce duplicate helpers and normalize includes; Scope: core/utils + include paths; Acceptance: helpers centralized, no include regressions; Tests: `ctest --preset user-ninja-multi-vcpkglt`.
