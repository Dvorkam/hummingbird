...
- [x] **[M3 P2] T-TEST-1: Full Test Suite + Note Skips**; Goal: run full suite and record skips; Scope: tests + TODO note; Acceptance: skips are documented with reasons; Tests: full suite (including `HB_RUN_SMOKE_TEST=1`).
